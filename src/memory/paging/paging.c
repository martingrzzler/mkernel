...
int paging_get_indexes(void *virtual_address, uint32_t *directory_index_out, uint32_t *table_index_out)
{
  ...
  // virtual address 0x40200 = dir[1][2] -> dividing v addr by Page size * table size would give floating point but is floored in c
...
/**
 * @param val -> 32 bit value containing physical address and flags
*/
